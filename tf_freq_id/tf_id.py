...
class TfIdent:
    ...
    def _create_tf_elements(self, sol=None, wc_limits=None):
        ...
        for i in range(self.model_order.NoPT2_numer):
            if sol:
                ...
                pt2 = self._create_PT2_var(
                    w0=w0, d0=d0, delta_lim=0.05, wc_limits=wc_limits)
            else:
        ...
        self.num_PT1s = [self._create_PT1_var()
                         for _ in range(self.model_order.NoPT1_numer)]
        self.den_PT1s = [self._create_PT1_var()
                         for _ in range(self.model_order.NoPT1_denom)]
